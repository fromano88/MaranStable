...
updateValues_TFM; evalin('base','caseSetup_TFM')
...
% run simulation
    ...
    if hObject == h.sy.pb.run(1)
        ...
        updateValues_TFM; evalin('base','caseSetup_TFM') % problem_specification
        evalin('base','flowopt.stability=0; grid_generation; block_assembly')
        evalin('base','iteration = 0; block_assembly; perturbation_amplitudes')
