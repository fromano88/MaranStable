...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    axes(h.gy.as.ld1);
    text(h.tp_l,h.tp_y,'$d_{1}=$',h.latex_l{:})
    ...
    %-------------------------------------------------------------------%
    axes(h.gy.as.ld2);
    text(h.tp_l,h.tp_y,'$d_{2}=$',h.latex_l{:})
    text(h.tp_r,h.tp_y,'mm',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.gy.as.rc);
    ...
    %-------------------------------------------------------------------%
    axes(h.gy.as.ro);
    text(h.tp_l,h.tp_y,'$r_o=$',h.latex_l{:})
    text(h.tp_r,h.tp_y,'mm',h.latex_r{:})
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%% mesh panel %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% --------------------------------------------------------------------- %
    for i = 1:3
        axes(h.mh.as.radialSG.spacing(i))
        if i == 2
            text(h.tp_l,h.tp_y,'$\Delta_\mathrm{max}=$',h.latex_l{:})
        else
            text(h.tp_l,h.tp_y,'$\Delta_\mathrm{min}=$',h.latex_l{:})
        ...
        %---------------------------------------------------------------%
        axes(h.mh.as.radialSG.stretchingC(i));
        text(h.tp_l,h.tp_y,'$f=$',h.latex_l{:})
    end
    ...
    text(-5.2,h.tp_y,'At $\,r = (r_i+r_o)/2$:',h.latex_r{:})
    text(1.1,h.tp_y,'$\%\,$ of $\,r_o-r_i$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.radialSG.spacing(3))
    text(-5.2,h.tp_y,'At $\,r=r_o$:',h.latex_r{:})
    text(1.1,h.tp_y,'$\%\,$ of $\,r_o-r_i$',h.latex_r{:})
    %-------------------------------------------------------------------%
    ...
    text(-5.2,h.tp_y,'At $\,r \cong (r_i+r_o)/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.radialSG.stretchingC(3));
    text(-5.2,h.tp_y,'At $\,r \cong r_o$:',h.latex_r{:})
     %------------------------------------------------------------------%
    axes(h.mh.as.radialSG.stretchingF(1));
    text(0.3,0.52,'At $\,r \cong r_i$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.radialSG.stretchingF(2));
    text(0.3,0.52,'At $\,r \cong (r_i+r_o)/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.radialSG.stretchingF(3));
    text(0.3,0.52,'At $\,r \cong r_o$:',h.latex_r{:})
% --------------------------------------------------------------------- %
% ------------------------axial-Surrounding-Gas------------------------ %
% --------------------------------------------------------------------- %
    for i = 1:7
        axes(h.mh.as.axialSG.spacing(i))
        if mod(i,2) == 0
            text(h.tp_l,h.tp_y,'$\Delta_\mathrm{max}=$',h.latex_l{:})
        else
            text(h.tp_l,h.tp_y,'$\Delta_\mathrm{min}=$',h.latex_l{:})
        end
        axes(h.mh.as.axialSG.stretchingC(i));
        text(h.tp_l,h.tp_y,'$f=$',h.latex_l{:})
    end
    axes(h.mh.as.axialSG.spacing(1))
    text(-3.54,h.tp_y,'At $\,z=d/2+d_{1}$:',h.latex_r{:})
    text(h.tp_r,h.tp_y,'$\%\,$ of $\,d_1$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.spacing(2))
    text(-3.54,h.tp_y,'At $\,z= d/2+d_{1}/2$:',h.latex_r{:})
    text(h.tp_r,h.tp_y,'$\%\,$ of $\,d_1$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.spacing(3))
    text(-3.54,h.tp_y,'At $\,z=d/2$:',h.latex_r{:})
    text(h.tp_r,h.tp_y,'$\%\,$ of $\,d$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.spacing(4))
    text(-3.54,h.tp_y,'At $\,z= 0$:',h.latex_r{:})
    text(h.tp_r,h.tp_y,'$\%\,$ of $\,d$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.spacing(5))
    text(-3.46,h.tp_y,'At $\,z= -d/2$:',h.latex_r{:})
    text(h.tp_r,h.tp_y,'$\%\,$ of $\,d$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.spacing(6))
    text(-3.46,h.tp_y,'At $\,z= -d/2-d_{2}/2$:',h.latex_r{:})
    text(h.tp_r,h.tp_y,'$\%\,$ of $\,d_2$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.spacing(7))
    text(-3.46,h.tp_y,'At $\,z= -d/2-d_{2}$:',h.latex_r{:})
    text(h.tp_r,h.tp_y,'$\%\,$ of $\,d_2$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingC(1));
    text(-3.54,h.tp_y,'At $\,z \cong d/2+d_{1}$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingC(2));
    text(-3.54,h.tp_y,'At $\,z \cong d/2+d_{1}/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingC(3));
    text(-3.54,h.tp_y,'At $\,z \cong d/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingC(4));
    text(-3.54,h.tp_y,'At $\,z \cong 0$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingC(5));
    text(-3.46,h.tp_y,'At $\,z \cong -d/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingC(6));
    text(-3.46,h.tp_y,'At $\,z \cong -d/2-d_{2}/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingC(7));
    text(-3.46,h.tp_y,'At $\,z \cong -d/2-d_{2}$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingF(1));
    text(-0.05,0.52,'At $\,z \cong d/2+d_{1}$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingF(2));
    text(-0.05,0.52,'At $\,z \cong d/2+d_{1}/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingF(3));
    text(-0.05,0.52,'At $\,z \cong d/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingF(4));
    text(-0.05,0.52,'At $\,z \cong 0$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingF(5));
    text(-0.05,0.52,'At $\,z \cong -d/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingF(6));
    text(-0.05,0.52,'At $\,z \cong -d/2-d_{2}/2$:',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.mh.as.axialSG.stretchingF(7));
    text(-0.05,0.52,'At $\,z \cong -d/2-d_{2}$:',h.latex_r{:})
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%% equations panel %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % -----------------------radial-Surrounding-Gas------------------------ %
    % --------------------------------------------------------------------- %
    axes(h.bc.as.radialSG.d1(1));
    text(0.4,0.52,'At $\,r = r_i: \, \, \, \, d/2 \leq z \leq d/2+d_1$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.bc.as.radialSG.d1(2));
    text(0.4*h.tp_l,h.tp_y,'$T_{r_i} = $',h.latex_l{:})
    text(0.94*h.tp_r,h.tp_y,'$^\circ$C',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.bc.as.radialSG.d2(1));
    text(0.4,0.52,'At $\,r = r_i: \, \, \, \, -d/2-d_2 \leq z \leq -d/2$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.bc.as.radialSG.d2(2));
    text(0.4*h.tp_l,h.tp_y,'$T_{r_i} = $',h.latex_l{:})
    text(0.94*h.tp_r,h.tp_y,'$^\circ$C',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.bc.as.radialSG.ro(1));
    text(0.4,0.52,'At $\,r = r_o: \, \, \, \, -d/2-d_2 \leq z \leq d/2+d_1$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.bc.as.radialSG.ro(2));
    text(0.4*h.tp_l,h.tp_y,'$T_{r_o} = $',h.latex_l{:})
    text(0.94*h.tp_r,h.tp_y,'$^\circ$C',h.latex_r{:})
% --------------------------------------------------------------------- %
% ------------------------axial-Surrounding-Gas------------------------ %
% --------------------------------------------------------------------- %
    axes(h.bc.as.axialSG.d1(1));
    text(0.4,0.52,'At $\,z = d/2+d_1: \, \, \, \, r_i \leq r \leq r_o$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.bc.as.axialSG.d1(2));
    text(0.4*h.tp_l,h.tp_y,'$T_{1} = $',h.latex_l{:})
    text(0.94*h.tp_r,h.tp_y,'$^\circ$C',h.latex_r{:})
    % --------------------------------------------------------------------- %
    axes(h.bc.as.axialSG.d2(1));
    text(0.4,0.52,'At $\,z = -d/2-d_2: \, \, \, \, r_i \leq r \leq r_o$',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.bc.as.axialSG.d2(2));
    text(0.4*h.tp_l,h.tp_y,'$T_{2} = $',h.latex_l{:})
    text(0.94*h.tp_r,h.tp_y,'$^\circ$C',h.latex_r{:})
    %-------------------------------------------------------------------%
    axes(h.bc.as.axialSG.d2(3));
