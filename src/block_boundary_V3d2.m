function[b,Rs]=block_boundary_V3d2(b, Rs, flowopt)
    ax=flowopt.ax;
    m=flowopt.m;
    g=flowopt.g;
...
%%%%%%%%%%%%%%%%%%%%%%% left / right boundary %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % missing term T1
        rhoTDcp_DT = rho(b.T.p).*b.T.p.*dcp(b.T.p).*(b.u.p.*derivative_xi_eta(b,b.T,'xi','p') + b.w.p.*derivative_xi_eta(b,b.T,'eta','p'));
        rhoTDcp_DT = rhoTDcp_DT.*b.R.p.^ax.*b.JA.p.*b.DXI.c.*b.DETA.c;
        rhoTDcpDT.rhs.T = [sparse(b.K,1) rhoTDcp_DT, sparse(b.K,1)];
        rhoTDcpDT.rhs.T = rhoTDcpDT.rhs.T.'; rhoTDcpDT.rhs.T=rhoTDcpDT.rhs.T(:);
...
%%%%%%%%%%%%%%%%%%%%%%% assembly %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if stability~=1
        if energy==1
            ...
            b.rhs=[[bc.rhs.u1; bc.rhs.ul+bc.rhs.ur; bc.rhs.uend]; [bc.rhs.w1; bc.rhs.wl+bc.rhs.wr+gravity.rhs.w; bc.rhs.wend]; [bc.rhs.T1; bc.rhs.Tl+bc.rhs.Tr+rhoTDcpDT.rhs.T; bc.rhs.Tend]; bc.rhs.C; sparse(b.sizeR1 + b.sizeRend,1)];
